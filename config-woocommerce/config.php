...
{
	global $wp_query;
	if( (is_search() || is_shop()) && empty($wp_query->found_posts) ){ echo "</div>";}
}
...
function avia_woocommerce_cart_dropdown()
{
	...
	$output .= "<a class='cart_dropdown_link' href='".$link."'><span class='avia-font-entypo-fontello'>". $avia_config['font_icons']['cart'] ."</span></a><!--<span class='cart_subtotal'>".$cart_subtotal."</span>-->";
