...
if ( !class_exists( 'avia_sc_notification' ) ) 
{
	class avia_sc_notification extends aviaShortcodeTemplate
	{
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(	"name" 	=> __("Message", 'avia_framework' ),
				            ...
				            "id" 	=> "content",
				            "type" 	=> "textarea",
				            "std" => "This is a notification of some sort."),
			...
			function editor_element($params)
			{
				...
				$inner .= "			<span data-update_with='icon_fakeArg' class='avia_message_box_icon avia-font-".$icon_el['font']."'>".$display_char."</span>";
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				{
					$output .= "<span class='avia_message_box_icon avia-font-".$icon_el['font']."'>".$display_char."</span>";
				}
