				...
				$this->elements = array(
						...
						array(
							...
							'subelements' 	=> array(
									...
									array(
									"name" 	=> __("Subtitle bellow name", 'avia_framework' ),
...
array(
	...
	//avatar
	if($src)	$avatar  = "<div class='avia-testimonial-image'>".wp_get_attachment_image( $src ,'thumbnail', false, array('alt'=>esc_attr(strip_tags($name))))."</div>";
