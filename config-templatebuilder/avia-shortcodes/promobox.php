...
if ( !class_exists( 'avia_sc_promobox' ) ) 
{
	class avia_sc_promobox extends aviaShortcodeTemplate
	{
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(	
							...
							"id" 	=> "content",
							"type" 	=> "tiny_mce",
							"std" 	=> __("Welcome Stranger! This is an example Text for your fantastic Promo Box! Feel Free to delete it and replace it with your own fancy Message!", "avia_builder" )),
			...
			function editor_element($params)
			{
				...
				$params['innerHtml'] .= "				<span data-update_with='icon_fakeArg' class='avia_button_icon avia-font-".$icon_el['font']."'>".$display_char."</span>";
