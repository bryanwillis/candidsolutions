		...
		<div class='container_wrap main_color <?php avia_layout_class( 'main' ); ?>'>
			...
			<div class='container'>	
				...
				*/
				...
				echo '<div data-fake-id="#tab-id-1" class="tab active_tab">Blog Posts</div>'."\n";
				...
				*/
	        	...
	        	$output .= "<h3>" . __('The 8 latest Portfolio Entries','avia_framework') . "</h3>";
	     		...
	     		echo '<div data-fake-id="#tab-id-2" class="tab">Portfolio</div>'."\n";
				...
				*/
				...
				echo '<div data-fake-id="#tab-id-3" class="tab">Pages</div>'."\n";
				echo '<div class="tab_content" >'."\n";
				echo '<div class="tab_inner_content">'."\n";
				...
				echo '<div data-fake-id="#tab-id-4" class="tab">Categories</div>'."\n";
				echo '<div class="tab_content" >'."\n";
				echo '<div class="tab_inner_content">'."\n";
				...
				echo '<div data-fake-id="#tab-id-5" class="tab">Monthly</div>'."\n";
				echo '<div class="tab_content" >'."\n";
				echo '<div class="tab_inner_content">'."\n";
